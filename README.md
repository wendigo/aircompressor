...
Each algorithm provides a simple block compression API using the `io.airlift.compressor.Compressor` 
and `io.airlift.compressor.Decompressor` classes. Block compression is the simplest form of
