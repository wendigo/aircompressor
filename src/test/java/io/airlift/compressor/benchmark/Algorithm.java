 ...
 */
package io.airlift.compressor.benchmark;
...
import io.airlift.compressor.lz4.Lz4Codec;
import io.airlift.compressor.lz4.Lz4JavaCompressor;
import io.airlift.compressor.lz4.Lz4JavaDecompressor;
import io.airlift.compressor.lz4.Lz4NativeCompressor;
import io.airlift.compressor.lz4.Lz4NativeDecompressor;
import io.airlift.compressor.lzo.LzoCodec;
import io.airlift.compressor.lzo.LzoCompressor;
import io.airlift.compressor.lzo.LzoDecompressor;
import io.airlift.compressor.snappy.SnappyCodec;
import io.airlift.compressor.snappy.SnappyJavaCompressor;
import io.airlift.compressor.snappy.SnappyJavaDecompressor;
import io.airlift.compressor.snappy.SnappyNativeCompressor;
import io.airlift.compressor.snappy.SnappyNativeDecompressor;
import io.airlift.compressor.thirdparty.HadoopLzoCompressor;
import io.airlift.compressor.thirdparty.HadoopLzoDecompressor;
import io.airlift.compressor.thirdparty.JPountzLz4Compressor;
import io.airlift.compressor.thirdparty.JPountzLz4Decompressor;
import io.airlift.compressor.thirdparty.JdkDeflateCompressor;
import io.airlift.compressor.thirdparty.JdkInflateDecompressor;
import io.airlift.compressor.thirdparty.XerialSnappyCompressor;
import io.airlift.compressor.thirdparty.XerialSnappyDecompressor;
import io.airlift.compressor.thirdparty.ZstdJniCompressor;
import io.airlift.compressor.thirdparty.ZstdJniDecompressor;
import io.airlift.compressor.zstd.ZstdJavaCompressor;
import io.airlift.compressor.zstd.ZstdJavaDecompressor;
import io.airlift.compressor.zstd.ZstdNativeCompressor;
import io.airlift.compressor.zstd.ZstdNativeDecompressor;
