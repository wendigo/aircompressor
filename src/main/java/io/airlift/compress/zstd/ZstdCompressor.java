...
{
    private final io.airlift.compressor.zstd.ZstdCompressor compressor;

    public ZstdCompressor()
    {
        this.compressor = ZstdNativeCompressor.isEnabled() ? new ZstdNativeCompressor() : new ZstdJavaCompressor();
    }
