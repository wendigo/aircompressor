...
{
    private final io.airlift.compressor.lz4.Lz4Decompressor decompressor;

    public Lz4Decompressor()
    {
        this.decompressor = Lz4NativeDecompressor.isEnabled() ? new Lz4NativeDecompressor() : new Lz4JavaDecompressor();
    }
