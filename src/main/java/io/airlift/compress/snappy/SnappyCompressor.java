...
{
    private final io.airlift.compressor.snappy.SnappyCompressor compressor;

    public SnappyCompressor()
    {
        this.compressor = SnappyNativeCompressor.isEnabled() ? new SnappyNativeCompressor() : new SnappyJavaCompressor();
    }
