 ...
 */
package io.airlift.compressor.zstd;

import io.airlift.compressor.MalformedInputException;

import java.util.Arrays;

import static io.airlift.compressor.zstd.BitInputStream.peekBits;
import static io.airlift.compressor.zstd.Constants.COMPRESSED_BLOCK;
import static io.airlift.compressor.zstd.Constants.COMPRESSED_LITERALS_BLOCK;
import static io.airlift.compressor.zstd.Constants.DEFAULT_MAX_OFFSET_CODE_SYMBOL;
import static io.airlift.compressor.zstd.Constants.LITERALS_LENGTH_BITS;
import static io.airlift.compressor.zstd.Constants.LITERAL_LENGTH_TABLE_LOG;
import static io.airlift.compressor.zstd.Constants.LONG_NUMBER_OF_SEQUENCES;
import static io.airlift.compressor.zstd.Constants.MAGIC_NUMBER;
import static io.airlift.compressor.zstd.Constants.MATCH_LENGTH_BITS;
import static io.airlift.compressor.zstd.Constants.MATCH_LENGTH_TABLE_LOG;
import static io.airlift.compressor.zstd.Constants.MAX_BLOCK_SIZE;
import static io.airlift.compressor.zstd.Constants.MAX_LITERALS_LENGTH_SYMBOL;
import static io.airlift.compressor.zstd.Constants.MAX_MATCH_LENGTH_SYMBOL;
import static io.airlift.compressor.zstd.Constants.MIN_BLOCK_SIZE;
import static io.airlift.compressor.zstd.Constants.MIN_SEQUENCES_SIZE;
import static io.airlift.compressor.zstd.Constants.MIN_WINDOW_LOG;
import static io.airlift.compressor.zstd.Constants.OFFSET_TABLE_LOG;
import static io.airlift.compressor.zstd.Constants.RAW_BLOCK;
import static io.airlift.compressor.zstd.Constants.RAW_LITERALS_BLOCK;
import static io.airlift.compressor.zstd.Constants.RLE_BLOCK;
import static io.airlift.compressor.zstd.Constants.RLE_LITERALS_BLOCK;
import static io.airlift.compressor.zstd.Constants.SEQUENCE_ENCODING_BASIC;
import static io.airlift.compressor.zstd.Constants.SEQUENCE_ENCODING_COMPRESSED;
import static io.airlift.compressor.zstd.Constants.SEQUENCE_ENCODING_REPEAT;
import static io.airlift.compressor.zstd.Constants.SEQUENCE_ENCODING_RLE;
import static io.airlift.compressor.zstd.Constants.SIZE_OF_BLOCK_HEADER;
import static io.airlift.compressor.zstd.Constants.SIZE_OF_BYTE;
import static io.airlift.compressor.zstd.Constants.SIZE_OF_INT;
import static io.airlift.compressor.zstd.Constants.SIZE_OF_LONG;
import static io.airlift.compressor.zstd.Constants.SIZE_OF_SHORT;
import static io.airlift.compressor.zstd.Constants.TREELESS_LITERALS_BLOCK;
import static io.airlift.compressor.zstd.UnsafeUtil.UNSAFE;
import static io.airlift.compressor.zstd.Util.fail;
import static io.airlift.compressor.zstd.Util.get24BitLittleEndian;
import static io.airlift.compressor.zstd.Util.mask;
import static io.airlift.compressor.zstd.Util.verify;
